...
// MongoDB connection
mongoose.connect(
  `mongodb+srv://${process.env.MONGODB_USERID}:${process.env.MONGODB_PASSWORD}@cluster0.glt9v7m.mongodb.net/${process.env.MONGODB_DATABASE}?retryWrites=true&w=majority`
)
