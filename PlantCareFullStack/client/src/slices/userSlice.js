...
// const API_URL = "http://localhost:7500"; // Your backend URL

// // ✅ Register new user
// export const registerThunk = createAsyncThunk("user/register", async (userData) => {
//   try {
//     const response = await axios.post(`${API_URL}/register`, userData);
//     return response.data; // { message, success, user }
//   } catch (err) {
//     console.error(err);
//     throw err;
//   }
...
//     return response.data; // { message, success, token, user }
//   } catch (err) {
//     console.error(err);
//     throw err;
//   }
